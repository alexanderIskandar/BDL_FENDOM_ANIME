...
<body>
	...
	<div class="container">
        <center><h1>Demon Character</h1></center>
        <hr>
				...
				<table class="table">
					...
					<?php 
						...
						foreach ($articles as $key => $article) {
							...
							echo "<a href = 'add_demon.php?action=delete&aid=".$article['_id']."'class='btn btn-danger fa fa-trash'></a>";
							echo "</td>";
							echo "</tr>";		
						}
					?>

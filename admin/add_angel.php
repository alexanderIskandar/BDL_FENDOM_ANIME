...
<body>
	...
	<div class="container">
        <center><h1>Angel Character</h1></center>
        <hr>
		    ...
		    <div class="col-md-8">
				...
				<table class="table">
					...
					<?php 
						$tabel = 'ktg';
						$keyword = 'angel';
						$filter = array($tabel=> new MongoDB\BSON\Regex($keyword, 'i'));
						...
						foreach ($articles as $key => $article) {
							...
							echo "<a href = 'add_angel.php?action=delete&aid=".$article['_id']."'class='btn btn-danger fa fa-trash'></a>";
							echo "</td>";
							echo "</tr>";		
						}
					?>

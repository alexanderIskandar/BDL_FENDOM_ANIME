...
<body class="bg" style="background-image: url(../img/history.jpg)">
	...
	<div class="container">
		<div class="isi">
			<center><b>TESMPEST</b></center> <br>
			<div class="paragraf">
				Jura Tempest Federation (ジュラ・テンペスト連邦国jura tenpesuto renpōkoku ? ), 
				juga dikenal sebagai Tempest (魔国連邦テ ン ペ ス ト tenpesuto , menyala. "Federasi Monster" ? ) adalah negara yang didirikan oleh Rimuru Tempest di Hutan Jura . <br> <br>
				<b>Latar Belakang</b>
			</div>
			<div class="paragraf">
				Awalnya didirikan di dekat Gua Tersegel setelah meninggalkan desa Goblin tua, negara ini dimulai sebagai desa Goblin baru yang dibangun oleh Dwarven Craftsmen. Desa ini kemudian bergabung dengan Lizardmen , Orc yang dibebaskan (sekarang High Orc), mengelilingi Goblin (sekarang Hobgoblin) serta Dryad dan Treant untuk menciptakan Aliansi Hutan Jura yang beberapa bulan kemudian berkembang menjadi Jura Tempest Federation, memulai pendirian bangsa dengan perjanjian magis dengan Armed Nation of Dwargon . <br> <br>
				<b></b>
			</div>
		</div>
	</div>
